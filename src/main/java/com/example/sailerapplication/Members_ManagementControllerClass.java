...
public class Members_ManagementControllerClass implements Initializable {
    ...
    public void NotifyMembers_function(ActionEvent e) throws MessagingException, SQLException {
         ...
         */
        sendMail("sailerappmailer@gmail.com");
    }


    public void sendMail(String recipient) throws MessagingException, SQLException {
        ...
        try {
            Connection con = getConnection();
                ...
                while (rs.next()) {
                    ...
                    System.out.println("Recipient adress " + recipient + "\n");
